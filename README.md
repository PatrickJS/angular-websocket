...
* CDN for development `https://rawgit.com/AngularClass/angular-websocket/v1.1.0/angular-websocket.js`
* CDN for production `https://cdn.rawgit.com/AngularClass/angular-websocket/v1.1.0/angular-websocket.min.js`
